...
public class SharedCounter {
    ...
    public void start(String[] args) {
        ...
        if (!ext) {
            ...
            DSSharedCounter[] cl = new DSSharedCounter[num];
            for (int i = 0; i < num; i++) {
                cl[i] = new DSSharedCounter(id + i, exec);
            }
            ...
            for (int i = 0; i < num; i++) {
                try {
                    ...
                    Logger.getLogger(SharedCounter.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            //new ExtSecureSharedCounter(id, ext_dir, exec).start();
             ...
             ExtSharedCounter[] cl = new ExtSharedCounter[num];
            
          
             
             for (int i = 0; i < num; i++) {
                cl[i] = new ExtSharedCounter(id+i, ext_dir, exec);
                /*if(i == 0){
                   cl[i].register = true; 
                }*/
            }
