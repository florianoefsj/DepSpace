...
public class DepTuple implements Externalizable {
    ...
    /**
     * ************************************************
     * CONSTRUCTORS	* called by 'create' methods	*
	 *************************************************
     */
    public DepTuple() {
        this.c_rd = null;
    ...
    /**
     * ************************************************
     * CREATORS	* create methods for several kinds of tuples	*
	 *************************************************
     */
    ...
    public boolean equals(Object object) {
        if (!(object instanceof DepTuple)) {
            return false;
        }
        DepTuple other = (DepTuple) object;
        if (publishedShares == null) {
            return (other.publishedShares == null);
        }
        if (other.publishedShares == null) {
            return false;
        }
        if (!publishedShares.equals(other.publishedShares)) {
            return false; // <--- Does the PublishedShares class implement equals()? 
        ...
        if (!Arrays.equals(c_rd, other.getC_rd())) {
            return false;
        }
        if (!Arrays.equals(c_in, other.getC_in())) {
            return false;
        }
...
//        buff.append(">");
    ...
    public boolean matches(DepTuple template) {
        int n = fields.length;
        if (n != template.fields.length) {
            return false;
        }
        for (int i = 0; i < n; i++) {
            if (WILDCARD.equals(template.fields[i])) {
                continue;
            }
            if (!fields[i].equals(template.fields[i])) {
                return false;
            }
        }
        return true;
    ...
    public DepTuple(byte[] buffer) throws Exception {
        ...
        //System.out.println("deptuple - deserealize: "+this.share);
