...
public class Context {
    ...
    public transient ConfidentialityScheme scheme;

    public Context(String tsName, ProtectionVector[] protectionVectors) {
        this.tsName = tsName;
    ...
    public static Context createDefaultContext(String tsName, DepSpaceOperation operation, boolean useConfidentiality, DepTuple... tuples) {
        ProtectionVector[] vectors = null;
        //TODO: deveria criar apenas se usasse confidencialidade
        switch (operation) {
                case CAS:
                case REPLACE:
    ...
    public void serialize(ObjectOutput stream) throws IOException {
        ...
        for (ProtectionVector protectionVector : protectionVectors) {
            stream.writeObject(protectionVector);
        }
    }
